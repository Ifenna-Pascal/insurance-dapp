...
function Profile() {
  ...
  const { currentAccount, checkWalletConnected, viewCount, contractDetails } =
  ...
  return (
    <div>
      <div className="grid grid-cols-3 gap-4 gap-x-8">
        <Card header={"Total Portfolios"} value={contractDetails?.count} />
        <Card header={"Total Amount"} value={contractDetails?.balance} />
